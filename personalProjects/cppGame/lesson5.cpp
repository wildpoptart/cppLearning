//wildpoptart
//lesson5
//Load image to window adding keyboard functionality to select images with upscaled images
...
bool loadMedia()
{
    ...
    gKeyPressSurfaces[ KEY_PRESS_SURFACE_DEFAULT ] = loadSurface( "gfx/block.bmp" );
